  ...
  return (
    <div className="p-8">
      ...
      <p className="text-lg text-slate-600 dark:text-slate-400">
        Esta é uma aplicação CRUD simples para demonstrar a interação entre um frontend em React e um backend em Node.js.
      </p>
      <div className="mt-8 p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold mb-2">Para a Professora</h2>
        <p>
        ...
        <ul className="list-disc list-inside mt-4 space-y-2">
          ...
          <li><strong>Clientes:</strong> Crie, liste, atualize o telefone e delete clientes.</li>
